...
from metrics import testacc, evasion_art_pgd
...
def main(args):
    ...
    for i in range(args.runs):
        ...
        phi_robacc_nodef = evasion_art_pgd.robust_test(args, model_nodef, testloader)
        ...
        phi_robacc_def = evasion_art_pgd.robust_test(args, model_robust, testloader)
