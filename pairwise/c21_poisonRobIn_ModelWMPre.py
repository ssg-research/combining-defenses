...
def main(args):
    ...
    for i in range(args.runs):
        ...
        phi_wmacc_nodef = watermarking.test_backdoor(args, testloader_poison, model_wm)
        phi_robacc_wm = poisoning.test(args, testloader_poison, model_wm)
        print("Test Accuracy: {:.2f}; WmAcc: {:.2f}; ASR: {:.2f}".format(phi_acc_wm,phi_wmacc_nodef, phi_robacc_wm))
        ...
        phi_wmacc_def = watermarking.test_backdoor(args, testloader_poison, model_robust)
        ...
        print("Test Accuracy: {:.2f}; WmAcc: {:.2f}; ASR: {:.2f}".format(phi_acc_def,phi_wmacc_def, phi_robacc_def))
    ...
    print("[No Defense] Test Accuracy: {:.2f} $\pm$ {:.2f}; WmAcc: {:.2f} $\pm$ {:.2f}; ASR: {:.2f} $\pm$ {:.2f}".format(phi_acc_nodef_list.mean(), phi_acc_nodef_list.std(), phi_wmacc_nodef_list.mean(), phi_wmacc_nodef_list.std(), phi_robacc_nodef_list.mean(), phi_robacc_nodef_list.std()))
    print("[Defense] Test Accuracy: {:.2f} $\pm$ {:.2f}; WmAcc: {:.2f} $\pm$ {:.2f}; ASR: {:.2f} $\pm$ {:.2f}".format(phi_acc_def_list.mean(), phi_acc_def_list.std(), phi_wmacc_def_list.mean(), phi_wmacc_def_list.std(), phi_robacc_def_list.mean(), phi_robacc_def_list.std()))
