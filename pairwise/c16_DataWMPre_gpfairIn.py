...
def main(args):
    ...
    for i in range(args.runs):
        ...
        print("Test Accuracy: {:.2f}; RSD: {:.2f}; Equalized Odds: {:.2f}".format(phi_acc_nodef,phi_wmacc_nodef, phi_eqodds_nodef))
        ...
        print("Test Accuracy: {:.2f}; RSD: {:.2f}; Equalized Odds: {:.2f}".format(phi_acc_wm,phi_wmacc_wm, phi_eqodds_wm))
        ...
        print("Test Accuracy: {:.2f}; RSD: {:.2f}; Equalized Odds: {:.2f}".format(phi_acc_fair,phi_wmacc_fair,phi_eqodds_fair))
        ...
        print("Test Accuracy: {:.2f}; RSD: {:.2f}; Equalized Odds: {:.2f}".format(phi_acc_wmfair, phi_wmacc_wmfair, phi_eqodds_wmfair))
