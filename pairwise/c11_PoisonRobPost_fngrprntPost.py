...
from defenses.fingerprint import postprocessing as postprocessingFNG
...
def main(args):
    ...
    for i in range(args.runs):
        ...
        fingerprinting = postprocessingFNG.Fingerprinting(args,
                                    model_nodef_poison,
                                    trainloader_poison,
                                    testloader,
                                    args.num_classes,
        ...
        temp_list_teacc, temp_list_asr, temp_list_models = [], [], []
        for u in thresholds:
        ...
        print("[Best] Test Accuracy: {:.2f}; Best Attack Success Rate (ASR): {:.2f}; pval: {}".format(phi_acc_def_best,phi_robacc_def_best,pval_def))
