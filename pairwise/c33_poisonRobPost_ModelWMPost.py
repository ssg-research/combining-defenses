...
def main(args):
    ...
    for i in range(args.runs):
        ...
        print("Test Accuracy: {:.2f}; Attack Success Rate (ASR): {:.2f}; Watermark Accuracy: {:.2f}".format(phi_acc_poison,phi_robacc_poison, phi_wmacc_nodef))
        ...
        print("[Best] Test Accuracy: {:.2f}; Best Attack Success Rate (ASR): {:.2f}; Watermark Accuracy: {:.2f}".format(phi_acc_def_best,phi_robacc_def_best, phi_wmacc_def))
    ...
    print("[No Defense] Test Accuracy: {:.2f} $\pm$ {:.2f}; Attack Success Rate (ASR): {:.2f} $\pm$ {:.2f}; Watermark Accuracy: {:.2f} $\pm$ {:.2f}".format(phi_acc_poison_list.mean(), phi_acc_poison_list.std(), phi_robacc_poison_list.mean(), phi_robacc_poison_list.std(), phi_wmacc_nodef_list.mean(), phi_wmacc_nodef_list.std()))
    print("[Defense] Test Accuracy: {:.2f} $\pm$ {:.2f}; Attack Success Rate (ASR): {:.2f} $\pm$ {:.2f}; Watermark Accuracy: {:.2f} $\pm$ {:.2f}".format(phi_acc_def_list.mean(), phi_acc_def_list.std(), phi_robacc_def_list.mean(), phi_robacc_def_list.std(), phi_wmacc_def_list.mean(), phi_wmacc_def_list.std()))
