...
from metrics import testacc, evasionauto
...
def main(args):
    ...
    for i in range(args.runs):
        ...
        phi_robacc_nodef = evasionauto.robust_test(args, model_nodef, testloader)
        ...
        phi_robacc_def = evasionauto.robust_test(args, model_robust, testloader)
