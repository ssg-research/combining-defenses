...
def main(args):
    ...
    for i in range(args.runs):
        ...
        phi_pval_nodef_list.append(pval)
        print("Test Accuracy: {:.2f}; Detection rate: {:.2f};  pval: {}".format(phi_acc_nodef,phi_wmacc_nodef, pval))
        ...
        print("Test Accuracy: {:.2f}; Detection rate: {:.2f}; pval: {}".format(phi_acc_wm,phi_wmacc_wm, pval_def))
    ...
    print("[No Defense] Test Accuracy: {:.2f} $\pm$ {:.2f}; Detection rate: {:.2f} $\pm$ {:.2f}; pval: {} $\pm$ {}".format(phi_acc_nodef_list.mean(), phi_acc_nodef_list.std(), phi_wm_nodef_list.mean(), phi_wm_nodef_list.std(), phi_pval_nodef_list.mean(), phi_pval_nodef_list.std()))
    print("[Defense] Test Accuracy: {:.2f} $\pm$ {:.2f}; Detection rate: {:.2f} $\pm$ {:.2f}; pval: {} $\pm$ {}".format(phi_acc_def_list.mean(), phi_acc_def_list.std(), phi_wm_def_list.mean(), phi_wm_def_list.std(), phi_pval_def_list.mean(), phi_pval_def_list.std()))
