...
def main(args):
    ...
    for i in range(args.runs):
        ...
        print("Test Accuracy: {:.2f}; Detection rate: {:.2f}; Watermark Accuracy: {:.2f}; Error: {:.4f}".format(phi_acc_nodef,phi_rsd_nodef,phi_wmacc_nodef,error_nodef))
        ...
        error_def = postprocExpl.generate_expl(model_wm, testloader, args)
        # DAWN
        ...
        print("Test Accuracy: {:.2f}; Detection rate: {:.2f}; Watermark Accuracy: {:.2f}; Error: {:.4f}".format(phi_acc_wm,phi_rsd_wm,phi_wmacc_wm,error_def))
    ...
    print("[No Defense] Test Accuracy: {:.2f} $\pm$ {:.2f}; Detection rate: {:.2f} $\pm$ {:.2f}; Watermarking Accuracy: {:.2f} $\pm$ {:.2f}; Error: {:.4f} $\pm$ {:.4f}".format(phi_acc_nodef_list.mean(), phi_acc_nodef_list.std(), phi_rsd_nodef_list.mean(), phi_rsd_nodef_list.std(), phi_wmacc_nodef_list.mean(), phi_wmacc_nodef_list.std(), phi_err_nodef_list.mean(), phi_err_nodef_list.std()))
    print("[Defense] Test Accuracy: {:.2f} $\pm$ {:.2f}; Detection rate: {:.2f} $\pm$ {:.2f}; Watermarking Accuracy: {:.2f} $\pm$ {:.2f}; Error: {:.4f} $\pm$ {:.4f}".format(phi_acc_def_list.mean(), phi_acc_def_list.std(), phi_rsd_def_list.mean(), phi_rsd_def_list.std(), phi_wmacc_def_list.mean(), phi_wmacc_def_list.std(), phi_err_def_list.mean(), phi_err_def_list.std()))
