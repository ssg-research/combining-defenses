...
def main(args):
    ...
    phi_err_poison_list, phi_err_robust_list, phi_err_fair_list, phi_err_fairrobust_list = [], [],[], []
    for i in range(args.runs):
        ...
        print("Test Accuracy: {:.2f}; Attack Success Rate (ASR): {:.2f}; Equalized Odds:{:.2f}; Error: {:.4f}".format(phi_acc_poison,phi_robacc_poison, phi_eqodds_poison,error_nodef))
        ...
        phi_err_poison_list.append(error_nodef)

        # pruning poisoned model
        thresholds = np.arange(0.6, 1.5, 0.05)
        temp_list_teacc, temp_list_asr, temp_list_eqodds, temp_list_models = [], [], [], []
        for u in thresholds:
            ...
            temp_list_models.append(model_robust)
        ...
        best_model = temp_list_models[index_best]
        error_robust = postprocExpl.generate_expl(best_model, testloader, args)
        print("[Best] Test Accuracy: {:.2f}; Best Attack Success Rate (ASR): {:.2f}; Best Equalized Odds: {:.2f}; Error: {:.4f}".format(phi_acc_robust_best,phi_robacc_robust_best, phi_eqodds_robust_best, error_robust))
        ...
        print("Test Accuracy: {:.2f}; Attack Success Rate (ASR): {:.2f}; Equalized Odds: {:.2f}; Error: {:.4f}".format(phi_acc_fair,phi_robacc_fair,phi_eqodds_fair,error_fair))
        ...
        for u in thresholds:
            ...
            temp_list_models.append(model_fair_robust)
        index_best = np.argmin(temp_list_asr)
        ...
        print("[Best] Test Accuracy: {:.2f}; Best Attack Success Rate (ASR): {:.2f}; Best Equalized Odds: {:.2f}; Error: {:.4f}".format(phi_acc_robfair_best,phi_robacc_robfair_best, phi_eqodds_robfair_best,error_robfair))
        ...
        phi_err_fairrobust_list.append(error_robfair)
    ...
    phi_err_poison_list, phi_err_robust_list, phi_err_fair_list, phi_err_fairrobust_list = np.array(phi_err_poison_list), np.array(phi_err_robust_list), np.array(phi_err_fair_list), np.array(phi_err_fairrobust_list)

    print("[Poison + NoDef] Test Accuracy: {:.2f} $\pm$ {:.2f}; Attack Success Rate (ASR): {:.2f} $\pm$ {:.2f}; Equalized Odds: {:.2f} $\pm$ {:.2f}; Error: {:.4f} $\pm$ {:.4f}".format(phi_acc_poison_list.mean(), phi_acc_poison_list.std(), phi_robacc_poison_list.mean(), phi_robacc_poison_list.std(), phi_eqodds_poison_list.mean(), phi_eqodds_poison_list.std(), phi_err_poison_list.mean(), phi_err_poison_list.std()))
    print("[Robust] Test Accuracy: {:.2f} $\pm$ {:.2f}; Attack Success Rate (ASR): {:.2f} $\pm$ {:.2f}; Equalized Odds: {:.2f} $\pm$ {:.2f}; Error: {:.4f} $\pm$ {:.4f}".format(phi_acc_robust_list.mean(), phi_acc_robust_list.std(), phi_robacc_robust_list.mean(), phi_robacc_robust_list.std(), phi_eqodds_robust_list.mean(), phi_eqodds_robust_list.std(), phi_err_robust_list.mean(), phi_err_robust_list.std()))
    print("[Fair + Poison] Test Accuracy: {:.2f} $\pm$ {:.2f}; Attack Success Rate (ASR): {:.2f} $\pm$ {:.2f}; Equalized Odds: {:.2f} $\pm$ {:.2f}; Error: {:.4f} $\pm$ {:.4f}".format(phi_acc_fair_list.mean(), phi_acc_fair_list.std(), phi_robacc_fair_list.mean(), phi_robacc_fair_list.std(), phi_eqodds_fair_list.mean(), phi_eqodds_fair_list.std(), phi_err_fair_list.mean(), phi_err_fair_list.std()))
    print("[Fair + Robust] Test Accuracy: {:.2f} $\pm$ {:.2f}; Attack Success Rate (ASR): {:.2f} $\pm$ {:.2f}; Equalized Odds: {:.2f} $\pm$ {:.2f}; Error: {:.4f} $\pm$ {:.4f}".format(phi_acc_fairrobust_list.mean(), phi_acc_fairrobust_list.std(), phi_robacc_fairrobust_list.mean(), phi_robacc_fairrobust_list.std(), phi_eqodds_fairrobust_list.mean(), phi_eqodds_fairrobust_list.std(), phi_err_fairrobust_list.mean(), phi_err_fairrobust_list.std()))
