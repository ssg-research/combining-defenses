...
def main(args):
    ...
    phi_err_nodef_list, phi_err_wm_list, phi_err_fair_list, phi_err_wmfair_list = [], [], [], []
    for i in range(args.runs):
        ...
        phi_wmacc_nodef = dataWatermarking.train_with_watermark(args, model_nodef, testset_poisoned, testdata_clean)
        ...
        print("Test Accuracy: {:.2f}; RSD: {:.2f}; Equalized Odds: {:.2f}; Error: {:.4f}".format(phi_acc_nodef,phi_wmacc_nodef, phi_eqodds_nodef,error_nodef))
        ...
        error_wm = postprocExpl.generate_expl(model_wm, testloader, args)
        print("Test Accuracy: {:.2f}; RSD: {:.2f}; Equalized Odds: {:.2f}; Error: {:.4f}".format(phi_acc_wm,phi_wmacc_wm, phi_eqodds_wm,error_wm))
        phi_acc_wm_list.append(phi_acc_wm)
        phi_wmacc_wm_list.append(phi_wmacc_wm) 
        phi_eqodds_wm_list.append(phi_eqodds_wm)
        phi_err_wm_list.append(error_wm)
        ...
        phi_wmacc_fair = dataWatermarking.train_with_watermark(args, model_fair, testset_poisoned, testdata_clean)
        phi_eqodds_fair = eqodds.test(args, model_fair, testloader)
        error_fair = postprocExpl.generate_expl(model_fair, testloader, args)
        print("Test Accuracy: {:.2f}; RSD: {:.2f}; Equalized Odds: {:.2f}; Error: {:.4f}".format(phi_acc_fair,phi_wmacc_fair,phi_eqodds_fair,error_fair))
        ...
        phi_wmacc_wmfair = dataWatermarking.train_with_watermark(args, model_wm_fair, testset_poisoned, testdata_clean)
        phi_eqodds_wmfair = eqodds.test(args, model_wm_fair, testloader)
        error_wmfair = postprocExpl.generate_expl(model_wm_fair, testloader, args)
        print("Test Accuracy: {:.2f}; RSD: {:.2f}; Equalized Odds: {:.2f}; Error: {:.4f}".format(phi_acc_wmfair, phi_wmacc_wmfair, phi_eqodds_wmfair, error_wmfair))
        ...
        phi_err_wmfair_list.append(error_wmfair)
    ...
    phi_err_nodef_list, phi_err_wm_list, phi_err_fair_list, phi_err_wmfair_list = np.array(phi_err_nodef_list), np.array(phi_err_wm_list), np.array(phi_err_fair_list), np.array(phi_err_wmfair_list)

    print("[No Defense] Test Accuracy: {:.2f} $\pm$ {:.2f}; Watermarking Accurcay: {:.2f} $\pm$ {:.2f}; Equalized Odds: {:.2f} $\pm$ {:.2f}; Error: {:.4f} $\pm$ {:.4f}".format(phi_acc_nodef_list.mean(), phi_acc_nodef_list.std(), phi_wmacc_nodef_list.mean(), phi_wmacc_nodef_list.std(), phi_eqodds_nodef_list.mean(), phi_eqodds_nodef_list.std(), phi_err_nodef_list.mean(), phi_err_nodef_list.std()))
    print("[Watermarking] Test Accuracy: {:.2f} $\pm$ {:.2f}; Watermarking Accuracy: {:.2f} $\pm$ {:.2f}; Equalized Odds: {:.2f} $\pm$ {:.2f}; Error: {:.4f} $\pm$ {:.4f}".format(phi_acc_wm_list.mean(), phi_acc_wm_list.std(), phi_wmacc_wm_list.mean(), phi_wmacc_wm_list.std(), phi_eqodds_wm_list.mean(), phi_eqodds_wm_list.std(), phi_err_wm_list.mean(), phi_err_wm_list.std()))
    print("[Fair] Test Accuracy: {:.2f} $\pm$ {:.2f}; Watermarking Accurcay: {:.2f} $\pm$ {:.2f}; Equalized Odds: {:.2f} $\pm$ {:.2f}; Error: {:.4f} $\pm$ {:.4f}".format(phi_acc_fair_list.mean(), phi_acc_fair_list.std(), phi_wmacc_fair_list.mean(), phi_wmacc_fair_list.std(), phi_eqodds_fair_list.mean(), phi_eqodds_fair_list.std(), phi_err_fair_list.mean(), phi_err_fair_list.std()))
    print("[Fair + Watermarking] Test Accuracy: {:.2f} $\pm$ {:.2f}; Watermarking Accuracy: {:.2f} $\pm$ {:.2f}; Equalized Odds: {:.2f} $\pm$ {:.2f}; Error: {:.4f} $\pm$ {:.4f}".format(phi_acc_wmfair_list.mean(), phi_acc_wmfair_list.std(), phi_wmacc_wmfair_list.mean(), phi_wmacc_wmfair_list.std(), phi_eqodds_wmfair_list.mean(), phi_eqodds_wmfair_list.std(),phi_err_wmfair_list.mean(), phi_err_wmfair_list.std()))
