...
def main(args):
    ...
    for i in range(args.runs):
        ...
        # DAWN
        dawn = postprocessing.DAWN(args,model_nodef_poison,trainloader_poison,testdata_clean,args.num_classes, args.device, args.alpha)
        ...
        # DAWN
        dawn = postprocessing.DAWN(args,model_robust,trainloader_poison,testdata_clean,args.num_classes, args.device, args.alpha)
        ...
        print("Test Accuracy: {:.2f}; Attack Success Rate (ASR): {:.2f}; Watermark Accuracy: {:.2f}; Error: {:.4f}".format(phi_acc_def,phi_robacc_def,phi_wmacc_def, error_def))
