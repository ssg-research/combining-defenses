...
def main(args):
    ...
    for i in range(args.runs):
        ...
        print("Test Accuracy: {:.2f}; Attack Success Rate (ASR): {:.2f}; Equalized Odds:{:.2f}; Watermark Accuracy: {:.2f}".format(phi_acc_poison,phi_robacc_poison, phi_eqodds_poison,phi_wmacc_nodef))
        ...
        print("[Best] Test Accuracy: {:.2f}; Best Attack Success Rate (ASR): {:.2f}; Best Equalized Odds: {:.2f}; Watermark Accuracy: {:.2f}".format(phi_acc_robust_best,phi_robacc_robust_best, phi_eqodds_robust_best, phi_wmacc_robust))
        ...
        print("Test Accuracy: {:.2f}; Attack Success Rate (ASR): {:.2f}; Equalized Odds: {:.2f}; Watermark Accuracy: {:.2f}".format(phi_acc_fair,phi_robacc_fair,phi_eqodds_fair,phi_wmacc_fair))
        ...
        print("[Best] Test Accuracy: {:.2f}; Best Attack Success Rate (ASR): {:.2f}; Best Equalized Odds: {:.2f}; Watermark Accuracy: {:.2f}".format(phi_acc_robfair_best,phi_robacc_robfair_best, phi_eqodds_robfair_best,phi_wmacc_robfair))
    ...
    print("[Poison + NoDef] Test Accuracy: {:.2f} $\pm$ {:.2f}; Attack Success Rate (ASR): {:.2f} $\pm$ {:.2f}; Equalized Odds: {:.2f} $\pm$ {:.2f}; Watermark Accuracy: {:.2f} $\pm$ {:.2f}".format(phi_acc_poison_list.mean(), phi_acc_poison_list.std(), phi_robacc_poison_list.mean(), phi_robacc_poison_list.std(), phi_eqodds_poison_list.mean(), phi_eqodds_poison_list.std(), phi_wmacc_nodef_list.mean(), phi_wmacc_nodef_list.std()))
    print("[Robust] Test Accuracy: {:.2f} $\pm$ {:.2f}; Attack Success Rate (ASR): {:.2f} $\pm$ {:.2f}; Equalized Odds: {:.2f} $\pm$ {:.2f};  Watermark Accuracy: {:.2f} $\pm$ {:.2f}".format(phi_acc_robust_list.mean(), phi_acc_robust_list.std(), phi_robacc_robust_list.mean(), phi_robacc_robust_list.std(), phi_eqodds_robust_list.mean(), phi_eqodds_robust_list.std(), phi_wmacc_robust_list.mean(), phi_wmacc_robust_list.std()))
    print("[Fair + Poison] Test Accuracy: {:.2f} $\pm$ {:.2f}; Attack Success Rate (ASR): {:.2f} $\pm$ {:.2f}; Equalized Odds: {:.2f} $\pm$ {:.2f};  Watermark Accuracy: {:.2f} $\pm$ {:.2f}".format(phi_acc_fair_list.mean(), phi_acc_fair_list.std(), phi_robacc_fair_list.mean(), phi_robacc_fair_list.std(), phi_eqodds_fair_list.mean(), phi_eqodds_fair_list.std(), phi_wmacc_fair_list.mean(), phi_wmacc_fair_list.std()))
    print("[Fair + Robust] Test Accuracy: {:.2f} $\pm$ {:.2f}; Attack Success Rate (ASR): {:.2f} $\pm$ {:.2f}; Equalized Odds: {:.2f} $\pm$ {:.2f}; Watermark Accuracy: {:.2f} $\pm$ {:.2f}".format(phi_acc_fairrobust_list.mean(), phi_acc_fairrobust_list.std(), phi_robacc_fairrobust_list.mean(), phi_robacc_fairrobust_list.std(), phi_eqodds_fairrobust_list.mean(), phi_eqodds_fairrobust_list.std(), phi_wmacc_fairrob_list.mean(), phi_wmacc_fairrob_list.std()))
