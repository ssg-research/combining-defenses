...
def generate_dataset(args, trainset, testset):
    ...
    if args.dataset == "FMNIST":
        ...
        trainset_poison = UTKPoison(args = args, dataset = trainset, train=True)
        testset_poisoned = UTKPoison(args=args, dataset=testset, train=False)

    return trainset_poison, testset_poisoned


def train_backdoor(args, model, trainloader, verbose = True):
