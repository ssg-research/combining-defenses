...
def main(args):
    ...
    dataload = {"FMNIST": data.process_fmnist_evasion,"UTKFACE": data.process_utkface, "CENSUS": data.process_census}
    ...
    for i in range(args.runs):
        if args.dataset == "FMNIST":
            ...
            model_robust = models.BinaryNet(num_features=93).to(args.device)
