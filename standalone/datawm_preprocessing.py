...
def main(args):
    ...
    for i in range(args.runs):
        ...
        print("Test Accuracy: {:.2f}; Detection rate: {:.2f}".format(phi_acc_nodef,phi_wmacc_nodef))
        ...
        print("Test Accuracy: {:.2f}; Detection rate: {:.2f}".format(phi_acc_wm,phi_wmacc_wm))
    ...
    print("[No Defense] Test Accuracy: {:.2f} $\pm$ {:.2f}; Detection rate: {:.2f} $\pm$ {:.2f}".format(phi_acc_nodef_list.mean(), phi_acc_nodef_list.std(), phi_wm_nodef_list.mean(), phi_wm_nodef_list.std()))
    print("[Defense] Test Accuracy: {:.2f} $\pm$ {:.2f}; Detection rate: {:.2f} $\pm$ {:.2f}".format(phi_acc_def_list.mean(), phi_acc_def_list.std(), phi_wm_def_list.mean(), phi_wm_def_list.std()))
