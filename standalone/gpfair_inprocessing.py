...
def main(args):
    ...
    phi_acc_nodef_list,phi_eqodds_nodef_list = [], []
    phi_acc_def_list,phi_eqodds_def_list = [], []
    ...
    print("[No Defense] Test Accuracy: {:.2f} $\pm$ {:.2f}; Equalized Odds: {:.2f} $\pm$ {:.2f}".format(phi_acc_nodef_list.mean(), phi_acc_nodef_list.std(), phi_eqodds_nodef_list.mean(), phi_eqodds_nodef_list.std()))
    print("[Defense] Test Accuracy: {:.2f} $\pm$ {:.2f}; Equalized Odds: {:.2f} $\pm$ {:.2f}".format(phi_acc_def_list.mean(), phi_acc_def_list.std(), phi_eqodds_def_list.mean(), phi_eqodds_def_list.std()))
