...
def main(args):
    ...
    for i in range(args.runs):
        ...
        phi_wmacc_nodef = testacc.test(args, model_nodef, dawn.watermarkloader)        
        phi_acc_wm = testacc.test(args, model_nodef, testloader)
        ...
        print("[No Defense] Test Accuracy: {:.2f}; Watermarking Accuracy: {:.2f}".format(phi_acc_nodef,phi_wmacc_nodef))
        print("[With Defense] Test Accuracy: {:.2f}; Watermarking Accuracy: {:.2f}".format(phi_acc_wm,phi_wmacc_wm))
