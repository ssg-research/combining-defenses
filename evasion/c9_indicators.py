...
def main(args):
    ...
    csv_name = f"evasion/results/c9_indicators_{args.dataset}_{args.attack_class}_{args.version}_nodef.csv"
    ...
    csv_name = f"evasion/results/c9_indicators_{args.dataset}_{args.attack_class}_{args.version}_def.csv"
    all_indicators_orig_eval.to_csv(csv_name, index=False) 
